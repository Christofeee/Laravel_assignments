    ...
    <div class="">
        ...
        <div class="mx-auto max-w-2xl py-10 sm:py-20 lg:py-30">
            <div class="text-center bg-black bg-opacity-80 rounded-xl p-5">
                <h1 class="text-4xl font-bold tracking-tight text-violet-500 sm:text-6xl">Cars</h1>
            </div>
        </div>
        ...
        <div class="flex flex row">
            ...
            <div
                ...
                <a href="#">
                    <img class="rounded-t-lg" src="{{ asset('images/' . $car->image_names) }}" alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{$car->car_names}}</h5>
                    </a>
